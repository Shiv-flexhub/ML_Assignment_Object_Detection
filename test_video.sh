...
INPUT_VIDEO=inputdData/temp/pexels_videos_2053100                     #e.g. /home/user/video.avi

# Provide full path to the weights file
WEIGHTS_PATH=weights/yolov4-tiny-bdd100k_best.weights          #e.g. /home/user/darknet/backup/

# Provide full path to the config file
CONFIG_PATH=config/yolov4-tiny-bdd100k.cfg                     #e.g. /home/user/darknet/cfg/

# Provide full path to the labels file
LABELS_PATH=data/bdd100k.names                                 #e.g. /home/user/darknet/config/
